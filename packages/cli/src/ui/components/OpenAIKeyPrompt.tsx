...
export function OpenAIKeyPrompt({
  ...
  useInput((input, key) => {
    ...
    if (input.includes('\n') || input.includes('\r')) {
      // Submit with default API key and base URL
      onSubmit(defaultApiKey, defaultBaseUrl, model.trim());
      return;
    }
  ...
  return (
    ...
    >
      ...
      <Box marginTop={1}>
        <Text>
          Please enter your OpenAI model. API key and base URL are pre-configured.
        </Text>
      </Box>
